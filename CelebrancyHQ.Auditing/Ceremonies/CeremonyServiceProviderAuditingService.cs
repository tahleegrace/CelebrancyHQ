...
{
    /// <summary>
    /// The ceremony service provider auditing service.
    /// </summary>
    public class CeremonyServiceProviderAuditingService : ICeremonyServiceProviderAuditingService
    {
        private readonly ICeremonyAuditLogRepository _ceremonyAuditLogRepository;

        /// <summary>
        /// Creates a new instance of CeremonyServiceProviderAuditingService.
        /// </summary>
        /// <param name="ceremonyAuditLogRepository">The ceremony audit logs repository.</param>
        public CeremonyServiceProviderAuditingService(ICeremonyAuditLogRepository ceremonyAuditLogRepository)
        {
        ...
        public List<AuditEvent> GenerateAuditEvents(CeremonyServiceProvider? oldEntity, CeremonyServiceProvider? newEntity)
        {
        ...
        public async Task SaveAuditEvents(CeremonyServiceProvider entity, Ceremony parentEntity, int personId, List<AuditEvent> auditEvents)
        {
